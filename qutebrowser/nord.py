...
c.url.default_page = 'file:///home/santette/.config/startpage/dashboard.html'
...
fg_default = "#abb2bf"
# "#b6bdca"
bg_lightest = "#e5e9f0"         # main shade lightest
fg_error = "#bf616a"            # red
# "#d19a66"                     # orange
bg_hint = "#ebcb8b"             # yellow
fg_matched_text = "#a3be8c"     # green
bg_passthrough_mode = "#88c0d0" # teal
bg_insert_mode = "#81a1c1"      # blue
bg_warning = "#b48ead"          # purple
custom = "#bd93f9"
# "#be5046"                     # dark red
